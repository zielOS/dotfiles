...
#+begin_src bash
emerge sys-kernel/cachyos-sources sys-kernel/linux-firmware sys-kernel/linux-headers sys-apps/fwupd sys-fs/cryptsetup sys-firmware/intel-microcode sys-kernel/dracut sys-kernel/installkernel sys-kernel/modprobed-db sys-fs/btrfs-progs sys-boot/grub sys-apps/rng-tools && eselect kernel set 1 && ls -l /usr/src/linux
#+end_src
...
#+begin_src bash
make -j22 && make modules_install && emerge nvidia-drivers && make install
#+end_src
...
nvme0n1
|-nvme0n1p1                                   85A2-DFFE
`-nvme0n1p2                                   38de55c7-1bac-4606-b417-1514e2b39b26
  `-cryptroot                                 b557ae73-0095-40d4-bc47-bfec5f079772
#+end_src
...
kernel_cmdline+=" rd.luks.uuid=38de55c7-1bac-4606-b417-1514e2b39b26 root=UUID=b557ae73-0095-40d4-bc47-bfec5f079772 root_trim=yes init=/lib/systemd/systemd nvidia-drm.modeset=1 rootfstype=btrfs rootflags=rw loglevel=3 quiet  apparmor=1 security=apparmor "
...
cryptroot UUID=38de55c7-1bac-4606-b417-1514e2b39b26     none luks
#+end_src
...
#+begin_src bash
default 50b58c553cb0b8eecdd454456691d176*
timeout 4
console-mode keep
editor no
...
machine-id 50b58c553cb0b8eecdd454456691d176
sort-key   gentoo
options    rd.luks.uuid=38de55c7-1bac-4606-b417-1514e2b39b26 root=UUID=b557ae73-0095-40d4-bc47-bfec5f079772 rw rootflags=subvol=/@ rootfstype=btrfs root_trim=yes loglevel=3 quiet init=/lib/systemd/systemd nvidia-drm.modeset=1 apparmor=1 security=apparmor systemd.machine_id=50b58c553cb0b8eecdd454456691d176
linux      /50b58c553cb0b8eecdd454456691d176/6.9.9-cachyos-6.9.9/linux
initrd     /50b58c553cb0b8eecdd454456691d176/6.9.9-cachyos-6.9.9/microcode-amd
initrd     /50b58c553cb0b8eecdd454456691d176/6.9.9-cachyos-6.9.9/microcode-intel
initrd     /50b58c553cb0b8eecdd454456691d176/6.9.9-cachyos-6.9.9/initrd
...
GRUB_CMDLINE_LINUX="loglevel=3 quiet crypt_root=UUID=72d75132-3818-4421-b86a-8929817d4de2 root_trim=yes init=/lib/systemd/systemd nvidia-drm.modeset=1 rootfstype=btrfs rootflags=rw"
